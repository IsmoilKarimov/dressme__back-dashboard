  ...
  return (
    <div className="w-full py-3 border border-solid border-lightBorderColor bg-lightBgColor px-10 ">
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
                <Link to='/search' className="flex items-center justify-center w-[52px] h-[52px] rounded-full border border-borderColor bg-white mr-5">
                ...
                <Link to='/notification' className="flex items-center justify-center w-[52px] h-[52px] rounded-full border border-borderColor bg-white mr-5">
