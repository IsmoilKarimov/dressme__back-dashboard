  ...
  return (
    <div className='w-full flex flex-col px-10'>
        ...
        <div className='flex items-center justify-between py-4 border-b border-lightBorderColor'>
          <div className='flex items-center text-[22px] font-medium '>С возвращением, Абдулазиз!</div>
          <div className='flex items-center h-12 border border-borderGrayColor rounded-lg'>
            <button className='pl-5 pr-[38px] h-full border-r border-borderGrayColor text-base font-medium'>01/01/23 – 30/06/23</button>
                ...
                <table className='w-full'>
                    <thead className='h-11 bg-lightBorderColor text-start rounded-t-xl text-sm'>
                        <tr className='rounded-xl '>
                            <th>Clothing type: <span className='text-textBlueColor'>T-Shirt</span></th>
                            <th>Category</th>
                            <th>Season</th>
                            <th>Orders</th>
                            <th>Rating</th>
                    ...
                    <tbody className='text-base text-center'>
                        {statistics.map(data =>(
                            <tr key={data.id} className={`h-11 ${data.id % 2 == 0 ? 'bg-paginationBackground' : 'bg-white'}  border-r border-lightBorderColor py-1`}>
                                <td className=' flex items-center px-[22px] py-[10px] border-r border-borderGrayColor'>
                                    <span className='w-[60px] h-[60px] border rounded-lg mr-7 bg-lightBgColor'>
