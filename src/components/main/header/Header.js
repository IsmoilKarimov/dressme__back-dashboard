  ...
  return (
    <div className="w-full py-3 border border-solid border-lightBorderColor bg-lightBgColor px-10 ">
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
                <button className="flex items-center justify-center w-14 h-14 rounded-full border border-borderColor bg-white mr-5">
                ...
                <button className="flex items-center justify-center w-14 h-14 rounded-full border border-borderColor bg-white">
