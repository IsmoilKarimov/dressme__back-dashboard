...
const SaleBreadCrumb = () => {
  return (
    <div className="w-full py-3 border border-solid border-lightBorderColor bg-lightBgColor px-10 ">
        <div className="flex items-center justify-between">
            <div className="flex items-center">
                <Link to='/' className="flex items-center">
                    <div className="text-base font-medium">Главная</div>
                    <svg className="mx-[14px] w-[22px]" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex items-center">
                <Link to='/search' className="flex items-center justify-center w-[52px] h-[52px] rounded-full border border-borderColor bg-white mr-4">
                ...
                <Link to='/notification' className="flex items-center justify-center w-[52px] h-[52px] rounded-full border border-borderColor bg-white mr-4">
                ...
                <Link to='/profile' className="flex items-center justify-center w-[52px] h-[52px] rounded-full border border-borderColor bg-white">
