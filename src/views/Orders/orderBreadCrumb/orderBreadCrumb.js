  ...
  return (
    <div className="w-full py-3 border border-solid border-lightBorderColor bg-lightBgColor px-10 ">
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
                <button className="flex items-center justify-center w-[52px] h-[52px] rounded-full border border-borderColor bg-white mr-4">
                ...
                <button className="flex items-center justify-center w-[52px] h-[52px] rounded-full border border-borderColor bg-white mr-4">
                    ...
                    <div className="w-[24px] h-[24px] bg-textRedColor rounded-full"><span className="flex items-center justify-center text-white">3</span></div>
                </button>
                <button className="flex items-center justify-center w-[52px] h-[52px] rounded-full border border-borderColor bg-white">
