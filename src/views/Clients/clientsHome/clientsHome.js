...
export default function SaleHome() {
  return (
    <div className='w-full flex flex-col px-10'>
        <div className='flex items-center justify-between border-b border-lightBorderColor'>
            <div className='flex items-center text-2xl font-medium py-[34px]'>Список клиентов</div>
            <div className='flex items-center'>
                <button className='flex items-center border border-lightBorderColor bg-lightBgColor px-6 py-3 rounded-xl mr-3'>
                  ...
                  <span className='font-medium text-lg ml-3'>7 клиентов</span>
                </button>
                <div className='flex items-center border border-lightBorderColor bg-lightBgColor rounded-xl px-6 py-3'>
                    <button className='flex items-center border-r border-lightBorderColor pr-5'>
                        ...
                        <span className='font-medium text-lg ml-3'>5 мужчин</span>
                    </button>
                ...
                <button className='flex items-center ml-5'>
                    ...
                    <span className='text-textBlueColor ml-2 font-medium'>Скрыть статистику</span>
                </button>
            </div>
        </div>
        ...
        <div className='w-full flex items-center mb-10'>
            <form className='w-full'>
                <div className='w-full flex items-center py-5 border-b border-lightBorderColor'>
                    <div className='w-[320px] h-[52px] flex items-center justify-between rounded-xl border border-lightBorderColor bg-lightBgColor px-5 mr-4'>
                    ...
                    <div className='h-[52px] flex items-center border border-lightBorderColor bg-lightBgColor rounded-xl px-5 py-2 mr-5'>
                        <button className='flex items-center border-r-2 border-lightBorderColor'>
                            ...
                            <span className='text-base font-medium ml-3 mr-3'>Фильтр</span>
                        </button>
                        <button className='flex items-center border-r-2 border-lightBorderColor flex-none'>
                            <span className='text-base font-medium ml-3 mr-3'>Возраст</span>
                        ...
                        <button className='flex items-center border-r-2 border-lightBorderColor'>
                            <span className='text-base font-medium ml-3 mr-3'>Пол</span>
                            <svg className='mr-6' width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.38 1.19727L5.18333 5.0006C5.6325 5.44977 6.3675 5.44977 6.81666 5.0006L10.62 1.19727" stroke="black" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </button>
                        <button className='flex items-center border-r-2 border-lightBorderColor'>
                            <span className='text-base font-medium ml-3 mr-3'>Размеры</span>
                            <svg className='mr-6' width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.38 1.19727L5.18333 5.0006C5.6325 5.44977 6.3675 5.44977 6.81666 5.0006L10.62 1.19727" stroke="black" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </button> 
        ...
        <div className='w-full flex flex-col mb-[60px]'>
            <div className='flex items-center text-2xl font-medium mb-[30px]'><span className='mr-3'>Дата:</span>31 май – 2023</div>
            ...
            <div className='w-full rounded-xl overflow-x-auto  font-medium saleScroll  border border-lightBorderColor'>
                <table className='w-[130%]'>
                    <thead className='bg-lightBorderColor text-start rounded-t-xl h-12 text-base'>
                        <tr className='rounded-xl '>
                            <th className=''>
                                <div className='w-7 h-7 m-auto rounded-lg bg-white border border-darkerBorderColor'></div>
                            </th>
                            <th>Время</th>
                            <th>Фото</th>
                    ...
                    <tbody className='text-lg text-center'>
                        <tr className='border-b border-lightBorderColor'>
                            <td>
                                <div className='w-7 h-7 m-auto rounded-lg bg-white border border-darkerBorderColor'></div>
                            </td>
                            <td>16:43</td>
                            <td>
                                {/* img */}
                                <div className='w-[72px] h-[72px] m-auto my-2 rounded-xl border border-darkerBorderColor bg-slate-100'></div> 
                            </td>
                            <td className='w-[12%] text-textBlueColor'>Спортивная мужская кроссовка Nike RUN</td>
                            <td>BAA-00004</td>
                            <td>Футболка</td>
                            <td>
                                <div className='w-9 h-9 m-auto bg-weatherSummerColor rounded-lg'></div>
                            </td>
                            <td>4XL</td>
                            <td>2 шт</td>
                            <td>452 000 сум</td>
                            <td className='text-textRedColor'>-226 000 сум</td>
                            <td>
                                <button className="flex items-center m-auto justify-center w-14 h-14 rounded-full border border-lightBorderColor bg-lightBgColor">
                                    <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='w-full h-12 flex items-center justify-between rounded-b-xl bg-lightBorderColor px-[50px]'>
                <div className='flex items-center'>
                    <div className='text-base font-medium mr-20 ml-[242px]'>Пластиковая карта: <span className='ml-3'>904 000 сум</span> </div>
                    <div className='text-base font-medium'>Наличные: <span className='mr-3'>0 сум</span> </div>
                </div>
                <div className='flex items-center'>
                    <div className='text-base font-medium mr-20'>Общая: <span className='ml-3'>904 000 сум</span> </div>
                    <div className='text-base font-medium text-textRedColor'>-452 000 сум <span className='text-black ml-[92px]'>1</span> </div>
                </div>
        ...
        <div className='w-full flex flex-col mb-[60px]'>
            <div className='flex items-center text-2xl font-medium mb-[30px]'><span className='mr-3'>Дата:</span>30 май – 2023</div>
