    ...
    <div className='w-full flex flex-col px-10'>
        <div className='flex items-center justify-between py-3 border-b border-lightBorderColor'>
            ...
            <button className='flex items-center bg-textBlueColor text-white px-10 py-4 rounded-xl'>
              ...
              <span className='ml-3 font-medium text-base'>Добавить продукт</span>
            </button>
        </div>
            ...
            <form className='w-full'>
                <div className='w-full flex items-center py-5 border-b border-lightBorderColor'>
                    ...
                    <button className='flex items-center h-12 border border-lightBorderColor bg-lightBgColor rounded-xl px-5 flex-none ml-auto'>
                        <span className='font-medium text-sm mr-[52px]'>Есть в наличии</span>
                        <svg width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1.38 1.19727L5.18333 5.0006C5.6325 5.44977 6.3675 5.44977 6.81666 5.0006L10.62 1.19727" stroke="black" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </button>
                    ...
                    <tbody className='text-base text-center h-11'>
                        {products.map(data =>(
                            <tr key={data.id} className={`${data.id % 2 == 0 ? 'bg-paginationBackground' : 'bg-white'}  border-b border-lightBorderColor`}>
                                ...
                                <td>
                                    <div className='flex items-center justify-center m-auto gap-x-[6px]'>
                                      <img src={star} alt="" />
                                      <span>{data.ranking}</span>  
                                    </div>    
                                </td>
                                <td>
                                    <button className='w-12 h-12 m-auto flex items-center justify-center rounded-xl border border-lightBorderColor bg-lightBgColor'>
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
