  ...
  return (
    <div className='w-full h-full'>
        ...
        <div className='calc w-full flex flex-col px-2'>
            ...
            <NavLink to='/online_chat' className='group active:text-textBlueColor focus:text-textBlueColor w-full rounded-xl flex items-center px-6 py-5 bg-lightBorderColor mb-1'>
                <div className='w-6 h-6 rounded-lg bg-gray-300 mr-6 group-active:bg-textBlueColor group-focus:bg-textBlueColor'></div>
                <div  className='text-[18px] font-medium'>Онлайн чат</div>
            </NavLink>
            <NavLink to='/settings' className='group active:text-textBlueColor focus:text-textBlueColor w-full rounded-xl flex items-center px-6 py-5 bg-lightBorderColor mb-1'>
                <div className='w-6 h-6 rounded-lg bg-gray-300 mr-6 group-active:bg-textBlueColor group-focus:bg-textBlueColor'></div>
